...
if($sem=='iii')
{
$i=mysql_query("insert into Takes values('$roll','$course','2013')");
}
else if($sem=='iv')
{
$i=mysql_query("insert into Takes values('$roll','$course','2014')");
}
...
{
$i=mysql_query("insert into Takes values('$roll','$course','2015')");
}
...
{
$course=$row1['course_id'];
$i=mysql_query("insert into Takes values('$roll','$course','Second Half 2013')");
}  
...
{
$course=$row1['course_id'];
$i=mysql_query("insert into Takes values('$roll','$course','First Half 2014')");
}  
...
{
$course=$row1['course_id'];
$i=mysql_query("insert into Takes values('$roll','$course','Second Half 2014')");
}  
...
{
$course=$row1['course_id'];
$i=mysql_query("insert into Takes values('$roll','$course','First Half 2015')");
}  
 }
}
